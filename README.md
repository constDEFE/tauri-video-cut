...
> Note: designed to run only on Windows systems
...
conversations, cringe moments - each of these are things it's great to someday look back on. And ever since this seed was planted in
my mind I literally started to record every session - every time my pc boots I immediately start OBS and click on a record button.
